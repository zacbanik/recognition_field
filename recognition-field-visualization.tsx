    ...
    <div className="flex flex-col items-center w-full bg-gray-900 text-blue-300 font-mono">
      ...
      <div className="mb-6 p-4 bg-gray-800 rounded-lg border border-blue-400 max-w-lg w-full">
        ...
        <div className="space-y-2">
          ...
          <button className="px-4 py-2 bg-blue-700 text-blue-100 rounded hover:bg-blue-600 border border-blue-400">
            Add to Field
          </button>
        </div>
        <p className="text-xs text-blue-300 mt-2">Note: This is a simplified interface. For deployment, connect this to a database or local storage.</p>
      </div>
